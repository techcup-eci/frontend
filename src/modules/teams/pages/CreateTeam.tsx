...
import { useCreateTeam, useAllTeams } from "../hooks/useTeams";
...
export default function CreateTeam() {
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		if (userRole !== "captain" && userRole !== "player") {
			toast.error("Debes tener rol de jugador o capitán para crear un equipo.");
			return;
		}
		...
		if (!result.success) {
			console.error("Team validation failed:", result.error.issues);
		...
		try {
			...
			// Auto-upgrade: promote PLAYER to CAPTAIN after creating team
					...
					<div className="mx-auto max-w-3xl space-y-8">
						<div>
							...
							<p className="text-muted-foreground">
								Completa la información de tu equipo para inscribirlo en el
								torneo
							</p>
						</div>
