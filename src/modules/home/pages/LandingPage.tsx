    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="border-t border-border bg-card py-16">
        <div className="container mx-auto max-w-6xl px-6">
          <div className="mb-8 flex items-center justify-between">
            ...
            <Link to="/organizer/standings" className="flex items-center gap-2 text-primary hover:underline">
          ...
          <div className="overflow-hidden rounded-xl border border-border bg-background">
            <table className="w-full">
              ...
              <tbody>
                {[
                  { pos: 1, team: "Los Algoritmos FC", pj: 6, pg: 5, pe: 1, pp: 0, pts: 16 },
                  { pos: 2, team: "Neural FC", pj: 6, pg: 4, pe: 2, pp: 0, pts: 14 },
                  { pos: 3, team: "Byte Brothers", pj: 6, pg: 4, pe: 1, pp: 1, pts: 13 },
                  { pos: 4, team: "Los Cibernéticos", pj: 6, pg: 3, pe: 2, pp: 1, pts: 11 },
                  { pos: 5, team: "Kernel Panic CF", pj: 6, pg: 3, pe: 1, pp: 2, pts: 10 },
                ].map((row) => (
                  <tr key={row.pos} className="border-t border-border hover:bg-muted/50">
        ...
        <div className="container mx-auto max-w-6xl px-6">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="rounded-xl border border-border bg-card p-6">
              ...
              <p className="text-muted-foreground">Los Algoritmos FC · 12 goles</p>
            </div>
            <div className="rounded-xl border border-border bg-card p-6">
              <div className="mb-4 flex items-center gap-3">
      ...
      <footer className="border-t border-border bg-card py-12">
        <div className="container mx-auto max-w-6xl px-6 text-center">
          <p className="mb-2 text-lg font-semibold">Escuela Colombiana de Ingeniería Julio Garavito</p>
          <p className="text-muted-foreground">Bogotá, Colombia</p>
          <p className="mt-4 text-sm text-muted-foreground">© 2025 TechCup Fútbol. Todos los derechos reservados.</p>
        </div>
      </footer>
    </div>
  );
