          ...
          <div className="mx-auto max-w-7xl space-y-8">
            <div className="rounded-xl border border-border bg-gradient-to-r from-primary to-primary/80 p-8 text-primary-foreground">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-primary-foreground/80">Consulta la informacion del torneo.</p>
                </div>
            ...
            <div className="grid gap-6 md:grid-cols-3">
              ...
              >
                ...
                <p className="text-sm text-muted-foreground">Calendario general, reglas y formato.</p>
              </Link>
              ...
              >
                ...
                <p className="text-sm text-muted-foreground">Resumen de goles, tarjetas y posiciones.</p>
              </Link>
              ...
              >
                ...
                <p className="text-sm text-muted-foreground">Consulta los equipos participantes.</p>
              </Link>
            </div>
          </div>
        </main>
