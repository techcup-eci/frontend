      ...
      <div className="flex flex-1">
        <main className="flex-1 bg-background p-8">
          <div className="mx-auto max-w-7xl space-y-8">
            <div>
              <h1 className="mb-2 text-3xl font-bold">Equipos inscritos</h1>
              <p className="text-muted-foreground">Consulta los equipos participantes en el torneo.</p>
            </div>
              ...
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                {filteredTeams.map((team) => (
                  <TeamCard
                    ...
                    onView={() => navigate(`/user/teams/${team.id}`)}
                  />
                ))}
              </div>
            ) : (
